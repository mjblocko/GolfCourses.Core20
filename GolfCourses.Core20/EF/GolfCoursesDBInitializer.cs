...
namespace GolfCourses.Core20.EF
{
    public class GolfCoursesDbInitializer
    {
        private static GolfCoursesContext context;

        public static void Initialize(IServiceProvider serviceProvider)
        {
            context = (GolfCoursesContext)serviceProvider.GetService(typeof(GolfCoursesContext));

            InitializeGolfCourses();
        }

        private static void InitializeGolfCourses()
        {
